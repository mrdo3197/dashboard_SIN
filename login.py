...
def generarMenu(usuario):
    ...
    with st.sidebar:
        ...
        st.write(f"¡Bienvenido! **:blue-background[{nombre}]** ")
        # Mostramos los enlaces de páginas icon=":material/home:"
        ...
        st.page_link("pages/energia_termica.py", label="Emisiones", icon=":material/flash_on:")     
